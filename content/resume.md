...
title: "Resume"
url: "/resume"
summary: "Computer Engineering Student & DevOps Aspirant"
showToc: true
disableShare: true
---
...
Passionate Computer Engineering student with a strong focus on **DevOps, Cloud Native technologies, and Automation**. Actively building projects with **Go, Docker, and Ansible**. I treat AI as a partner in engineering, not just a tool. My goal is to bridge the gap between development and operations with modern tools.
...
*Ege University* | *2024 - Present*
* Focus areas: Algorithms, System Programming, Operating Systems.

---

## 🏆 Certificates & Learning
* **Linux Journey:** Completed (Advanced Text-fu, Processes, etc.)
* **OverTheWire Bandit:** Level 15+ (Active Player)
